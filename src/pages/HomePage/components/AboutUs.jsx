    ...
    return (
        <section className='bg-[#485d92]'>
            <div className='max-w-7xl mx-auto px-8 py-10'>
                ...
                <div className='grid lg:grid-cols-2 space-x-20'>
                    <div className="space-y-8">
                        <div className="bg-[#485d92] space-y-4 px-8 py-4 shadow-secondary-foreground  shadow-md rounded-lg">
                            ...
                            <p className="text-lg leading-relaxed text-[#ffffff] font-medium">
                        ...
                        <div className="bg-[#485d92] space-y-4 px-8 py-4 shadow-secondary-foreground  shadow-md rounded-lg">
                            ...
                            <p className="text-lg text-[#ffffff] leading-relaxed font-medium">
